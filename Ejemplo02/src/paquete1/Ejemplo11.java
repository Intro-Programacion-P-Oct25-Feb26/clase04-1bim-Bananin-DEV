...
public class Ejemplo11 {
    ...
    public static void main(String[] args) {
        ...
        nombreAsignatura1 = entrada.nextLine(); // nextLine me permite recibir una cadena con scanner
        System.out.println("Ingrese nota de asignatura 1");
        notaAsignatura1 = entrada.nextDouble();

        // %.2f significa que voy a recibir un decimal y lo presenta de forma redondeada y legible
